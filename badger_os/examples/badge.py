...
class Badge:
    def __init__(self, badge_data_path):
        ...
        self.jpeg = jpegdec.JPEG(self.display.display)
    ...
    def prepare(self):
        ...
        self.company_text = self.truncatestring(self.company_text, self.company_text_size, TEXT_WIDTH)
    ...
    def draw(self):
        ...
        # Draw badge image
        self.jpeg.open_file(self.image_path)
        self.jpeg.decode(WIDTH - IMAGE_WIDTH, 0)
